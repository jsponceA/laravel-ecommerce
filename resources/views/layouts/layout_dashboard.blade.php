...
<head>
    ...
    <title>DASHBOARD - @yield("titulo","INICIO")</title>
    ...
    <!-- Ekka CSS -->
    <link id="ekka-css" href="{{asset('assets/dashboard/css/ekka.css')}}" rel="stylesheet" />
...
<div class="wrapper">
        ...
        <div id="sidebar" class="sidebar ec-sidebar-footer">
            ...
            <div class="ec-brand">
                <a href="index.html" title="Ekka">
                    <img class="ec-brand-icon" src="{{asset('assets/dashboard/img/logo/ec-site-logo.png')}}" alt="" />
    ...
    <div class="ec-page-wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                            <button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                <img src="{{asset('assets/dashboard/img/user/user.png')}}" class="user-image" alt="User Image" />
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
                                <!-- User image -->
                                <li class="dropdown-header">
                                    <img src="{{asset('assets/dashboard/img/user/user.png')}}" class="img-circle" alt="User Image" />
                                            ...
                                            <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                    ...
                                                    <a href="javscript:void(0)"
                                                       class="media media-message media-notification">
                                                        <div class="position-relative mr-3">
                                                            <img class="rounded-circle" src="{{asset('assets/dashboard/img/user/u2.jpg')}}"
                                                                 alt="Image">
                                                ...
                                                <li>
                                                    <a href="javscript:void(0)"
                                                       class="media media-message media-notification media-active">
                                                        <div class="position-relative mr-3">
                                                            <img class="rounded-circle" src="{{asset('assets/dashboard/img/user/u1.jpg')}}"
                                                                 alt="Image">
                                                ...
                                                <li>
                                                    <a href="javscript:void(0)"
                                                       class="media media-message media-notification">
                                                        <div class="position-relative mr-3">
                                                            <img class="rounded-circle" src="{{asset('assets/dashboard/img/user/u5.jpg')}}"
                                                                 alt="Image">
                                                            <span class="status away"></span>
                                                        </div>
                                                        <div class="media-body d-flex justify-content-between">
                                            ...
                                            <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                <li>
                                                    <a href="javscript:void(0)"
                                                       class="media media-message media-notification">
                                                        <div class="position-relative mr-3">
                                                            <img class="rounded-circle" src="{{asset('assets/dashboard/img/user/u6.jpg')}}"
                                                                 alt="Image">
                                                            <span class="status away"></span>
                                                        </div>
                                                        <div class="media-body d-flex justify-content-between">
                                                ...
                                                <li>
                                                    <a href="javscript:void(0)"
                                                       class="media media-message media-notification">
                                                        <div class="position-relative mr-3">
                                                            <img class="rounded-circle" src="{{asset('assets/dashboard/img/user/u7.jpg')}}"
                                                                 alt="Image">
                                                            <span class="status away"></span>
                                                        </div>
                                                        <div class="media-body d-flex justify-content-between">
        ...
        <div class="ec-content-wrapper">
            <div class="content" id="app"><!-- Start Content -->
                @yield("content")
            </div> <!-- End Content -->
            ...
            <div class="copyright bg-white">
                <p>
                    Copyright &copy; <span id="ec-year"></span><a class="text-primary"
                                                                  href="#" target="_blank"> Ecommerce</a>. Todos los derechos reservados.
                </p>
            </div>
        </footer>
...
<!-- Common Javascript -->
<script src="{{asset('assets/dashboard/plugins/jquery/jquery-3.5.1.min.js')}}"></script>
<script src="{{asset('assets/dashboard/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{asset('assets/dashboard/plugins/simplebar/simplebar.min.js')}}"></script>
<script src="{{asset('assets/dashboard/plugins/jquery-zoom/jquery.zoom.min.js')}}"></script>
...
<!-- Option Switcher -->
<script src="{{asset('assets/dashboard/plugins/options-sidebar/optionswitcher.js')}}"></script>

<!-- Ekka Custom -->
<script src="{{asset('assets/dashboard/js/ekka.js')}}"></script>
