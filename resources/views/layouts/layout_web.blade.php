...
<head>
    ...
    <meta name="author" content="jponce">
    <!-- METE TAGS ADICIONALES POR SI SE NECESITA PARA CADA VISTA -->
    @yield("meta-tags")

    <!-- site Favicon -->
    <link rel="icon" href="{{asset('assets/web/images/favicon/favicon.png')}}" sizes="32x32"/>
    <link rel="apple-touch-icon" href="{{asset('assets/web/images/favicon/favicon.png')}}"/>
    <meta name="msapplication-TileImage" content="{{asset('assets/web/images/favicon/favicon.png')}}"/>

    <!-- css Icon Font -->
    <link rel="stylesheet" href="{{asset('assets/web/css/vendor/ecicons.min.css')}}"/>

    <!-- css All Plugins Files -->
    <link rel="stylesheet" href="{{asset('assets/web/css/plugins/animate.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/web/css/plugins/swiper-bundle.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/web/css/plugins/jquery-ui.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/web/css/plugins/countdownTimer.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/web/css/plugins/slick.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/web/css/plugins/bootstrap.css')}}"/>

    <!-- Main Style -->
    <link rel="stylesheet" href="{{asset('assets/web/css/demo1.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/web/css/style.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/web/css/responsive.css')}}"/>

    <!-- Background css -->
    <link rel="stylesheet" id="bg-switcher-css" href="{{asset('assets/web/css/backgrounds/bg-4.css')}}">

    <!-- extra styles por si necesitas agregar un css especifico a una vista en particular -->
    @stack("css")
</head>
                ...
                <div class="ec-flex">
                    ...
                    <div class="align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="assets/web/images/logo/logo.png" alt="Site Logo" /><img
                                    class="dark-logo" src="assets/web/images/logo/dark-logo.png" alt="Site Logo"
                                    ...
                                    <li>
                                        <ul class="ec-main-banner w-100">
                                            <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img
                                                        class="img-responsive" src="assets/web/images/menu-banner/1.jpg"
                                                        alt=""></a></li>
                                            <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img
                                                        class="img-responsive" src="assets/web/images/menu-banner/2.jpg"
                                                        alt=""></a></li>
                                            <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img
                                                        class="img-responsive" src="assets/web/images/menu-banner/3.jpg"
                                                        alt=""></a></li>
                                            <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img
                                                        class="img-responsive" src="assets/web/images/menu-banner/4.jpg"
                                                        alt=""></a></li>
                                        </ul>
                                    </li>
                                </ul>
                    ...
                    <li><a href="javascript:void(0)">Categories</a>
                        <ul class="sub-menu">
                            ...
                            <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive"
                                                                                        src="assets/web/images/menu-banner/1.jpg" alt=""></a>
                            </li>
                        </ul>
                    </li>
            ...
            <ul class="eccart-pro-items">
                <li>
                    <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                            src="assets/web/images/product-image/6_1.jpg" alt="product"></a>
                ...
                <li>
                    <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                            src="assets/web/images/product-image/12_1.jpg" alt="product"></a>
                    <div class="ec-pro-content">
                ...
                <li>
                    <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                            src="assets/web/images/product-image/3_1.jpg" alt="product"></a>
                    <div class="ec-pro-content">
            ...
            <div class="ec-sidebar-wrap">
                ...
                <div class="ec-sidebar-block">
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="assets/web/images/icons/dress-8.png"
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="assets/web/images/icons/shoes-8.png"
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="assets/web/images/icons/jewelry-8.png"
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="assets/web/images/icons/perfume-8.png"
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="assets/web/images/icons/cosmetics-8.png"
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="assets/web/images/icons/glasses-8.png"
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="assets/web/images/icons/bag-8.png"
            ...
            <div class="ec-sb-pro-sl">
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="assets/web/images/product-image/1.jpg" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="assets/web/images/product-image/2.jpg" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="assets/web/images/product-image/3.jpg" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="assets/web/images/product-image/4.jpg" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="assets/web/images/product-image/5.jpg" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="assets/web/images/product-image/6.jpg" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="assets/web/images/product-image/7.jpg" alt="product" /></a>
                        <div class="ec-pro-content">
...
<!-- CONTENIDO DINAMICO PARA CADA VISTA INICIO-->
@yield("content")
<!-- CONTENIDO DINAMICO PARA CADA VISTA FIN -->
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="#"><img src="assets/web/images/logo/footer-logo.png"
                                                                         alt=""><img class="dark-footer-logo" src="assets/web/images/logo/dark-logo.png"
                    ...
                    <div class="col footer-bottom-right">
                        <div class="footer-bottom-payment d-flex justify-content-end">
                            <div class="payment-link">
                                <img src="assets/web/images/icons/payment.png" alt="">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                        ...
                        <div class="qty-product-cover">
                            <div class="qty-slide">
                                <img class="img-responsive" src="assets/web/images/product-image/3_1.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="assets/web/images/product-image/3_2.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="assets/web/images/product-image/3_3.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="assets/web/images/product-image/3_4.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="assets/web/images/product-image/3_5.jpg" alt="">
                            </div>
                        </div>
...
<div id="ec-popnews-box">
    ...
    <div class="row">
        <div class="col-md-6 disp-no-767">
            <img src="assets/web/images/banner/newsletter.png" alt="newsletter">
        </div>
        <div class="col-md-6">
...
<div class="recent-purchase">
    <img src="assets/web/images/product-image/1.jpg" alt="payment image">
    <div class="detail">
                       ...
                       data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="ec-img-cont">
                                <img src="assets/web/images/whatsapp/profile_01.jpg" class="ec-user-img"
                                     alt="Profile image">
                    ...
                    <a class="ec-list" data-number="918866774266"
                       data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                        <div class="d-flex bd-highlight">
                            <!-- Profile Picture -->
                            <div class="ec-img-cont">
                                <img src="assets/web/images/whatsapp/profile_02.jpg" class="ec-user-img"
                                     alt="Profile image">
                    ...
                    <a class="ec-list" data-number="918866774266"
                       data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                        <div class="d-flex bd-highlight">
                            <!-- Profile Picture -->
                            <div class="ec-img-cont">
                                <img src="assets/web/images/whatsapp/profile_03.jpg" class="ec-user-img"
                                     alt="Profile image">
                    ...
                    <a class="ec-list" data-number="918866774266"
                       data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                        <div class="d-flex bd-highlight">
                            <!-- Profile Picture -->
                            <div class="ec-img-cont">
                                <img src="assets/web/images/whatsapp/profile_04.jpg" class="ec-user-img"
                                     alt="Profile image">
                                <span class="ec-status-icon ec-offline"></span>
                            </div>
                            <!-- Display Name & Last Seen -->
...
<div class="ec-tools-sidebar">
    ...
    <a href="#" class="ec-tools-sidebar-toggle in-out">
        <img alt="icon" src="assets/web/images/common/settings.png">
    </a>
...
<!-- Vendor JS -->
<script src="{{asset('assets/web/js/vendor/jquery-3.5.1.min.js')}}"></script>
<script src="{{asset('assets/web/js/vendor/popper.min.js')}}"></script>
<script src="{{asset('assets/web/js/vendor/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/js/vendor/jquery-migrate-3.3.0.min.js')}}"></script>
...
<script src="{{asset('assets/web/js/plugins/countdownTimer.min.js')}}"></script>
<script src="{{asset('assets/web/js/plugins/scrollup.js')}}"></script>
<script src="{{asset('assets/web/js/plugins/jquery.zoom.min.js')}}"></script>
<script src="{{asset('assets/web/js/plugins/slick.min.js')}}"></script>
<script src="{{asset('assets/web/js/plugins/infiniteslidev2.js')}}"></script>
<script src="{{asset('assets/web/js/vendor/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('assets/web/js/plugins/jquery.sticky-sidebar.js')}}"></script>
...
<!-- Main Js -->
<script src="{{asset('assets/web/js/vendor/index.js')}}"></script>
<script src="{{asset('assets/web/js/main.js')}}"></script>

<!-- extra scripts por si necesitas agregar un JS especifico a una vista en particular -->
@stack("js")
</body>
</html>
