...
function ecCheckCookie() {
    ...
    if (bgImageMode != "") {
        ...
        $("#bg-switcher-css").attr("href", window.laravel.baseUrl+"/assets/web/css/backgrounds/" + bgID + ".css");
    }
    ...
    if (rtlMode != "") {
        ...
        var $link = $('<link>', {
            rel: 'stylesheet',
            href: window.laravel.baseUrl+'/assets/web/css/rtl.css',
            class: 'rtl'
        });
    ...
    if (darkMode != "") {
        var $link = $('<link>', {
            rel: 'stylesheet',
            href: window.laravel.baseUrl+'/assets/web/css/dark.css',
            class: 'dark'
        });

        $(`link[href='${window.laravel.baseUrl}/assets/web/css/responsive.css']`).before($link);
        ...
        if (themeColor != "") {
            ...
            if (themeColor != '01') {
                $(`link[href='${window.laravel.baseUrl}/assets/web/css/responsive.css']`).before('<link rel="stylesheet" href="'+window.laravel.baseUrl+'/assets/web/css/skin-' + themeColor + '.css" rel="stylesheet">');
            }
        }
    }
}
...
(function ($) {
    ...
    $('.ec-change-color').on('click', 'li', function () {
        $(`link[href^="${window.laravel.baseUrl}/assets/web/css/skin-"]`).remove();
        $('link.dark').remove();
        ...
        if (dataValue != undefined) {
            $(`link[href='${window.laravel.baseUrl}/assets/web/css/responsive.css']`).before('<link rel="stylesheet" href="'+window.laravel.baseUrl+'/assets/web/css/skin-' + dataValue + '.css" rel="stylesheet">');
